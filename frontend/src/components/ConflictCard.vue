<template>
  <article class="card">
    ...
    <div class="content">
      ...
      <div class="chips">
        <span v-for="c in conflict.countryCodes || []" :key="c" class="chip">{{ c }}</span>
      </div>
...
.chip{ background:#eef6ff; color:#073b79; padding:6px 8px; border-radius:999px; font-weight:600; font-size:13px }
